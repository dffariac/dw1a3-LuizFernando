...
const DOM = {
  ...
  innerHTMLTransaction(transaction, index) {
    ...
    <td class ="situation">${transaction.situation} </td>
...
const Form = {
    ...
    situation: document.querySelector('input#situation'),
  ...
  validateFields() {
    const { description, amount, date,category, situation } = Form.getValues()
  ...
  formatValues() {
    let { description, amount, date , category , situation } = Form.getValues()
